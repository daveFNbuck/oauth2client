...
"""oauth2client_latest Service account credentials class."""
    ...
    def _from_parsed_json_keyfile(cls, keyfile_dict, scopes,
        ...
        if not revoke_uri:
            revoke_uri = keyfile_dict.get('revoke_uri',
                                          oauth2client_latest.GOOGLE_REVOKE_URI)
...
class _JWTAccessCredentials(ServiceAccountCredentials):
    ...
    def create_scoped(self, scopes, token_uri=oauth2client_latest.GOOGLE_TOKEN_URI,
                      revoke_uri=oauth2client_latest.GOOGLE_REVOKE_URI):
