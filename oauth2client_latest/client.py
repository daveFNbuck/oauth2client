...
#       moved into `oauth2client_latest.transport`,
...
class Storage(object):
    ...
    def locked_get(self):
        ...
        Returns:
            oauth2client_latest.client.Credentials
        """
        raise NotImplementedError
...
class GoogleCredentials(OAuth2Credentials):
    ...
    def __init__(self, access_token, client_id, client_secret, refresh_token,
        ...
        Args:
            ...
            revoke_uri: string, URI for revoke endpoint. Defaults to
                        oauth2client_latest.GOOGLE_REVOKE_URI; a token can't be
    ...
    def from_json(cls, json_data):
        ...
        if (data['_module'] == 'oauth2client_latest.service_account' and
                data['_class'] == 'ServiceAccountCredentials'):
            return service_account.ServiceAccountCredentials.from_json(data)
        elif (data['_module'] == 'oauth2client_latest.service_account' and
...
def _get_application_default_credential_GAE():
    from oauth2client_latest.contrib.appengine import AppAssertionCredentials
...
def _require_crypto_or_die():
    ...
    The oauth2client_latest.crypt module requires either PyCrypto or PyOpenSSL
...
def verify_id_token(id_token, audience, http=None,
    ...
    Raises:
        oauth2client_latest.crypt.AppIdentityError: if the JWT fails to verify.
...
def credentials_from_code(client_id, client_secret, scope, code,
                          ...
                          revoke_uri=oauth2client_latest.GOOGLE_REVOKE_URI,
                          device_uri=oauth2client_latest.GOOGLE_DEVICE_URI,
