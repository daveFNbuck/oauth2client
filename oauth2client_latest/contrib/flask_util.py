...
.. code-block:: python
    ...
    from oauth2client_latest.contrib.flask_util import UserOAuth2
...
:class:`oauth2client_latest.Storage`.
"""
    ...
    def init_app(self, app, scopes=None, client_secrets_file=None,
        ...
        Arguments:
            ...
            authorize_callback: A function that is executed after successful
                user authorization.
            storage: A oauth2client_latest.client.Storage subclass for storing the
