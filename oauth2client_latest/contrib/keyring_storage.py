...
class Storage(client.Storage):
    ...
    not installed with oauth2client_latest by default because it does not work on all
    the platforms that oauth2client_latest supports, such as Google App Engine.
    ...
    Usage::
        ...
        from oauth2client_latest import keyring_storage
