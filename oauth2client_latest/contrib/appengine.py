...
from oauth2client_latest.contrib import xsrfutil

# This is a temporary fix for a Google internal issue.
try:
    from oauth2client_latest.contrib import _appengine_ndb
...
oauth2client_latest_NAMESPACE = 'oauth2client_latest#ns'
...
def xsrf_secret_key():
    ...
    Returns:
        The secret key.
    """
    secret = memcache.get(XSRF_MEMCACHE_ID, namespace=oauth2client_latest_NAMESPACE)
    if not secret:
        ...
        memcache.add(XSRF_MEMCACHE_ID, secret,
                     namespace=oauth2client_latest_NAMESPACE)
...
class AppAssertionCredentials(client.AssertionCredentials):
    ...
    def sign_blob(self, blob):
        ...
        :meth:`oauth2client_latest.client.AssertionCredentials.sign_blob`.
...
class CredentialsProperty(db.Property):
    ...
    oauth2client_latest.Credentials
    """
