...
.. code-block:: python
   ...
   from oauth2client_latest.contrib.django_util.site import urls as oauth2_urls
...
.. code-block:: python
   ...
   from oauth2client_latest.contrib.django_util.decorators import oauth_required
...
.. code-block:: python
   ...
   from oauth2client_latest.contrib.django_util.decorators import oauth_enabled
...
.. code-block:: python
   ...
   from oauth2client_latest.contrib.django_util.signals import oauth2_authorized
...
:class:`oauth2client_latest.contrib.django_util.models.CredentialsField` with the name
...
from oauth2client_latest.contrib.django_util import storage
...
def _get_storage_model():
    ...
    Returns:
        ...
        :class:`oauth2client_latest.contrib.django_util.models.CredentialsField`
